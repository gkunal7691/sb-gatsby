...
import "../../assests/styles/tools/online-json-to-yaml-convertor.scss"

const JsonToYAML = () => {
  return (
    <SbHeading
      sbHeadingActive={"online-json-to-yaml-convertor"}
      title="Free Online Json to YAML or YML Convertor"
      subtitle="'We provide free online Json to YAML or YML Convertor which will help many developers in their daily work."
    >
      <div className="tool-container">
        <SbTextArea type="input" className="text-area" />
        <div className="button-align">
          <button className="btn btn-outline-primary">JSON TO YAML</button>
        </div>
      ...
      <div className="grid-container text-container">
        <div>
          ...
          <p>
            This is an online tool that converts your JSON format data to YAML
            data format and vice versa. It converts JSON objects into an YAML
            tree structure.
          </p>
          ...
          <ol>
            ...
            <li>
              Press the &ldquo;JSON to YAML button&rdquo; to convert the data
              into YAML.
            </li>
            <li>
          ...
          <p>The attributes that are objects (key-value pairs).</p>
          <p>
          ...
          <p>
            ...
            format so we need JSON to YAML or vice versa helps you to convert
          ...
          <p>
            Our tools will help in converting the data from JSON to YAML or YAML
